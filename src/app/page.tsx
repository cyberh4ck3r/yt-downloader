            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-3">
              ...
              <div className="flex gap-1 rounded-lg border border-white/[0.08] bg-white/[0.02] backdrop-blur-sm p-1">
                <button type="button" disabled={loading} onClick={() => { setMode("audio"); setFormat("mp3"); }}
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" className="size-3.5" fill="currentColor"><path d="M381.9 388.2c-6.4 27.4-27.2 42.8-55.1 48-24.5 4.5-44.9 5.6-64.5-10.2-23.9-20.1-24.2-53.4-2.7-74.4 17-16.2 40.9-19.5 76.8-25.8 6-1.1 11.2-2.5 15.6-7.4 6.4-7.2 4.4-4.1 4.4-163.2 0-11.2-5.5-14.3-17-12.3-8.2 1.4-185.7 34.6-185.7 34.6-10.2 2.2-13.4 5.2-13.4 16.7 0 234.7 1.1 223.9-2.5 239.5-4.2 18.2-15.4 31.9-30.2 39.5-16.8 9.3-47.2 13.4-63.4 10.4-43.2-8.1-58.4-58-29.1-86.6 17-16.2 40.9-19.5 76.8-25.8 6-1.1 11.2-2.5 15.6-7.4 10.1-11.5 1.8-256.6 5.2-270.2 .8-5.2 3-9.6 7.1-12.9 4.2-3.5 11.8-5.5 13.4-5.5 204-38.2 228.9-43.1 232.4-43.1 11.5-.8 18.1 6 18.1 17.6 .2 344.5 1.1 326-1.8 338.5z"/></svg>
                  Audio
                </button>
                <button type="button" disabled={loading} onClick={() => { setMode("video"); setFormat("720"); }}
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" className="size-3.5" fill="currentColor"><path d="M96 64c-35.3 0-64 28.7-64 64l0 256c0 35.3 28.7 64 64 64l256 0c35.3 0 64-28.7 64-64l0-256c0-35.3-28.7-64-64-64L96 64zM464 336l73.5 58.8c4.2 3.4 9.4 5.2 14.8 5.2 13.1 0 23.7-10.6 23.7-23.7l0-240.6c0-13.1-10.6-23.7-23.7-23.7-5.4 0-10.6 1.8-14.8 5.2L464 176 464 336z"/></svg>
                  Video
                </button>
              </div>
